...
//Use Case 5 is to extend the max method to also print the max to std out using Generic Method.
    ...
    public class ExtendAndPrintTheMax <T extends Comparable<T>> {

        //Creating 3 variables.
        T x, y, z;

        //Creating Parameterized constructor for generic data types.
        public ExtendAndPrintTheMax(T x, T y, T z) {
            this.x = x;
            this.y = y;
            this.z = z;
        }
        ...
        public T maximum()
        {
            return ExtendAndPrintTheMax.maximum(x, y, z);
        }
        ...
        public void main(String[] args) {
            ...
            ExtendAndPrintTheMax testMaximum = new ExtendAndPrintTheMax();
            ...
            ExtendAndPrintTheMax.testMaximum(xStr, yStr, zStr);
            new ExtendAndPrintTheMax(xInt, yInt, zInt).maximum();
            new ExtendAndPrintTheMax(xFlt, yFlt, zFlt).maximum();
            new ExtendAndPrintTheMax(xStr, yStr, zStr).maximum();
